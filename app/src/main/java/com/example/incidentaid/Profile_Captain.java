...
public class Profile_Captain extends AppCompatActivity {
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (new_password.length() == 0) {
                    ...
                    Toast.makeText(Profile_Captain.this, "Address and Pincode Updated", Toast.LENGTH_LONG).show();
                    finish();
                }
                        ...
                        user.updatePassword(new_password).addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if (task.isSuccessful()) {
                                    Toast.makeText(Profile_Captain.this, "Password has been updated", Toast.LENGTH_SHORT).show();
                                    finish();
//                                startActivity(new Intent(Profile.this,Incident_Cmd_Home.class));
                                } else {
                                    Log.e(TAG, "Error in updating Profile", task.getException());
                                    Toast.makeText(Profile_Captain.this, "Failed to Update Password.", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
                    } else {
                        ...
                        user.updatePassword(new_password).addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    Log.e(TAG, "Error in updating Profile", task.getException());
                                    Toast.makeText(Profile_Captain.this, "Failed to Update.", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
    ...
    public void onBackPressed() {
        ...
        startActivity(new Intent(Profile_Captain.this, Captain_DashBoard.class));
        super.onBackPressed();
    }
